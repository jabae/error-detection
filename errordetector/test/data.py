...
class Dataset(torch.utils.data.Dataset):
  ...
  def __getitem__(self, idx):
    ...
    sample = {"image": image, "reconstruct": obj_label, "obj_mask": obj_mask}
...
class Data(object):
  ...
  def __init__(self, opt, data, vol_ids, patch_size, out_size, is_train=True):
    
    self.build(opt, data, vol_ids, patch_size, out_size, is_train)
  ...
  def build(self, opt, data, vol_ids, patch_size, out_size, is_train):
