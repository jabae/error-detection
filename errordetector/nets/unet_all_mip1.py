...
class Classify(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv = nn.Conv3d(in_channels, out_channels, kernel_size=(1,5,5), bias=True)
        self.maxpool = nn.MaxPool3d(kernel_size=(33,1,1), stride=1, padding=0)
...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.out0 = Classify(fs[5], 1)

        self.uconv1 = UpConvBlock3(fs[5], fs[4])
        self.out1 = ConvOut(fs[4], 1)
